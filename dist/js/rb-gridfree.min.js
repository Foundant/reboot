...
s.initialize(),s.resize(),$(window).on("resize",function(){RBGridFree.instances.forEach(function(e){e.resetResize()}),RBGridFree.instances.forEach(function(e){e.resize()})}),$(e).closest(".rb-tab").on("tab:open",function(){s.resize()})},0)})
